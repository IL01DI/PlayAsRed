...
; Characteristics of each move.
	...
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           75, FIRE0,        100, 15
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT,          75, ICE0,         100, 15
	move THUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       75, ELECTRIC0,    100, 15
	move SCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        55, NORMAL,       100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   CHARGE_EFFECT,               80, NORMAL0,      100, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 20
	move CUT,          NO_ADDITIONAL_EFFECT,        50, NORMAL,        95, 30
	move GUST,         NO_ADDITIONAL_EFFECT,        40, FLYING0,      100, 35
	...
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        45, GRASS0,       100, 25
	...
	move POISON_STING, POISON_SIDE_EFFECT1,         15, POISON0,      100, 35
	...
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,        1, NORMAL0,       90, 20
	...
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL0,       90,  5
	...
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        55, GRASS0,        95, 25
	...
	move WATERFALL,    FLINCH_SIDE_EFFECT1,         80, WATER0,       100, 15
	move CLAMP,        TRAPPING_EFFECT,             35, WATER0,        85, 15
	move SWIFT,        SWIFT_EFFECT,                60, NORMAL0,      100, 20
	move SKULL_BASH,   CHARGE_EFFECT,              130, NORMAL,       100, 10
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,        90, 15
	...
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,       100, WATER0,        90, 10
	...
	move TRI_ATTACK,   NO_ADDITIONAL_EFFECT,        80, NORMAL0,      100, 10
